...
const data = [
    { name: 'Персональные данные', value: 34, id: 1 },
    { name: 'Стратегии развития', value: 20, id: 2 },
    { name: 'Бизнес-планы', value: 19, id: 3 },
    { name: 'Патенты, ноу-хау, интеллектуальная собественность', value: 18, id: 4 },
    { name: 'Кредитные карты, финансовая и бухгалтерская информация', value: 17, id: 5 }
];
        ...
        return (
            <>
                <div className="row justify-content-center">
                    <Label style={{fontSize: "2em"}}>Объекты охраны</Label>
                </div>
                <div className="row justify-content-center">
